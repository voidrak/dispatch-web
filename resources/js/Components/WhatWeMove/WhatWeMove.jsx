  ...
  return (
    <div id="what_we_move" className="flex flex-col bg-bg-light px-1">
      ...
      <div className="mx-auto grid max-w-[437x] grid-cols-2 gap-1 pt-16 min-[450px]:px-2 sm:grid-cols-3 md:px-6 lg:px-8 xl:max-w-[1280px] xl:gap-3 xl:px-16 2xl:min-w-[1536px]">
        <img
          className="duration-300 xl:w-[100%]"
        ...
        />
        <img
          className="-translate-y-[31%] duration-300 sm:translate-y-0 xl:w-[100%]"
          src="images/what-we-move-top-right.webp"
          alt="dry van"
        />
        <img
          className="translate-y-[10%] duration-300 sm:-translate-y-[41%] xl:w-[100%]"
          src="images/what-we-move-center-left.webp"
          alt="semi track"
        />
        <img
          className="-translate-y-[50%] duration-300 sm:-translate-y-[10%] xl:w-[100%]"
          src="images/what-we-move-center-center.webp"
          alt="flat bed"
        />
        <div className="bg-transparent"></div>
        <img
          className="-translate-y-[50%] duration-300 sm:-translate-y-[65%] xl:w-[100%]"
          src="images/what-we-move-bottom-left.webp"
          alt="straight box truck"
        />
        <div className="bg-transparent sm:hidden sm:bg-red-500"></div>
        <img
          className="mb-10 -translate-y-[50%] duration-300 sm:-translate-y-[65%] xl:w-[100%]"
          src="images/what-we-move-bottom-center.webp"
          alt="reefer"
        />
        <img
          className="-translate-y-[90%] duration-300 sm:-translate-y-[83%] xl:w-[100%]"
          src="images/what-we-move-bottom-right.webp"
          alt="step deck"
        />
      </div>
      <button className="mx-auto -translate-y-[150px] rounded-md bg-black px-8 py-2 text-white duration-200 md:-translate-y-[250px] lg:-translate-y-[350px] lg:px-16 lg:py-4 xl:-translate-y-[450px]">
